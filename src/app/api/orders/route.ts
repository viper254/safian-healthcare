...
const orderSchema = z.object({
  ...
  payment_method: z.enum(["mpesa", "till", "mpesa_till", "card", "cash_on_delivery", "bank_transfer"]),
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Stock will be reduced automatically when order status changes to 'confirmed'
    // via the database trigger (adjust_product_stock_on_order_status)
